...
function ee(){
if(form1.DDDDD.value==""){alert("ÇëÊäÈëÕËºÅ");form1.DDDDD.focus();return false;}
if(form1.upass.value==""){alert("ÇëÊäÈëÃÜÂë");form1.upass.focus();return false;}
f0.DDDDD.value=form1.DDDDD.value
if(ps==0){f0.upass.value=xproc1(form1.upass.value);}
else{tmpchar=pid+form1.upass.value+calg;f0.upass.value=calcMD5(tmpchar)+calg+pid;f0.R2.value=1;}
...
function Clicked(){
	...
	if(osele!=1){
		...
		open("http://"+v4serip+":9002/In0","p99","width=420,height=160,left=0,top=0,toolbar=no,crollbars=no,status=no");
	}
}
